...
class CameraHomography extends React.Component {
    ...
    render() {
        ...
        return (
            <Page justify={'flex-start'} align={'flex-start'} withHeader withSideBar>
                <SectionHeader title={'Configurar homografía de cámara de seguimiento: ' + this.props.location.state.camera.name} />
